...
/*
 * Web Minimal — scope is strictly the three features required by the v1.1
 * base distribution firmware:
 *
 *   1. Network config  (GET/POST /api/network)
 *   2. Serial  config  (GET/POST /api/serial)
 *   3. Serial  debug   (POST /api/serial/send + WS /ws/serial)
 *
